                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('guru.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('guru.update', $guru->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="squareText">Nama Guru</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="Nama Guru" name="nama" value="{{$guru->nama}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">NIP Guru</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="NIP Guru" name="nip" value="{{$guru->nip}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Jabatan Guru</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="Jabatan Guru" name="jabatan" value="{{$guru->jabatan}}">
                                            </div>
                                            <div class="form-group">
