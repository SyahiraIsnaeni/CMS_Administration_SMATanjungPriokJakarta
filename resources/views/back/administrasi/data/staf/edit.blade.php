        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu" style="margin-top: -10px">
                <ul class="menu">
                    ...
                    <li class="sidebar-title  active ">Data Sekolah</li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('staf.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('staf.update', $staf->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="squareText">Nama Staf</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="Nama Staf" name="nama" value="{{$staf->nama}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">NIP Staf</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="NIP Staf" name="nip" value="{{$staf->nip}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="squareText">Jabatan Staf</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="Jabatan Staf" name="jabatan" value="{{$staf->jabatan}}">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <img src="{{asset('uploads/'.$staf->foto) }}" width="100">
                                            </div>
                                            <div class="form-group">
