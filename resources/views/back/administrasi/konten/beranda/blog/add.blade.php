                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('blog.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <form method="post" action="{{ route('blog.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control square"
                                                          placeholder="Enter Deskripsi" name="body" style="height: 200px"></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group" style="margin-top: 20px">
                                                <label for="blog" class="form-label">Gambar Blog</label>
