                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('blog.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('blog.update', $blog->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="blog">Nama Penulis</label>
                                            ...
                                            <div class="form-group">
                                                <label for="blog">Deskripsi Blog</label>
                                                <textarea type="text" class="form-control square"
                                                          placeholder="Enter Deskripsi" name="body" style="height: 200px">{{ $blog->body}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="blog">Kategori</label>
                                                <select name="kategori_blog_id" class="form-control">
                                                    @foreach ($kategori_blog as $row)
                                                        @if ($row->id == $blog->kategori_blog_id)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="{{asset('uploads/'.$blog->gambar) }}" width="100">
                                            </div>
                                            <div class="form-group">
