                ...
                <ul class="menu">
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            ...
                            <li class="submenu-item  ">
                                <a href="{{ route('blog.index') }}" class="submenu-link">Berita</a>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('ekstrakurikuler.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
