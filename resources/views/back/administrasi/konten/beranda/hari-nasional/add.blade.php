...
<head>
    ...
    <title>Tambah Data Postingan Hari Nasional</title>
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Tambah Data Postingan Hari Nasional</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('hari.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('hari.store')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="squareText">Nama Hari Nasional</label>
                                                <input type="text" id="squareText" class="form-control square"
                                                       placeholder="Hari Nasional" name="nama_hari">
                                            </div>
