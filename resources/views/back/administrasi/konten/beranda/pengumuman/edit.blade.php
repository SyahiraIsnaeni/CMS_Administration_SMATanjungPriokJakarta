                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('pengumuman.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('pengumuman.update', $pengumuman->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="penulis" class="form-control" id="text" value="{{$pengumuman->penulis}}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control square"
                                                          placeholder="Enter Deskripsi" name="body" style="height: 200px">{{ $pengumuman->body}}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            @if ($pengumuman->dokumen != null)
                                                <div class="form-group">
                                                    <label for="dokumen">Dokumen Pengumuman</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="file" id="formFile" name="gambar" style="margin-bottom: 10px">
                                                <label for="gambar">Gambar Saat Ini</label><br>
                                                <img src="{{asset('uploads/'.$pengumuman->gambar) }}" width="100">
                                            </div>
                                            <div class="form-group">
