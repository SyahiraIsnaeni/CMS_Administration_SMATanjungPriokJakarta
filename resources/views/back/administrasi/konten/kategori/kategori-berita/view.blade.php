...
<div id="app">
    @include('back.administrasi.sidebar.kategori-berita')
    <div id="main">
        <header class="mb-3">
                                ...
                                <div class="card-body">
                                    <div class="card-header">
                                        <div class="card-head-row" style="margin-left: -20px">
                                            <a href="{{route('kategori-berita.create')}}" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        @forelse ($kategori_berita as $row)
                                                            <tr>
                                                                ...
                                                                <td class="text-bold-500"><a href="{{route('kategori-berita.edit', $row->id) }}" class="btn icon btn-primary"><i class="bi bi-pencil"></i></a>
                                                                    <br>
