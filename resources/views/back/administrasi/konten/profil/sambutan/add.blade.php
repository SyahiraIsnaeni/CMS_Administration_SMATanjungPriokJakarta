...
<head>
    ...
    <title>Tambah Data Sambutan Kepala Sekolah</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('sambutan.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('sambutan.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="squareText">Sambutan Kepala Sekolah</label>
                                                <textarea name="sambutan" id="sambutan" class="form-control" style="height: 300px">
