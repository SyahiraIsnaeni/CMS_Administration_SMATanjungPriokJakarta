                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-head-row">
                            <a href="{{route('sambutan.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <form method="post" action="{{ route('sambutan.update', $sambutan->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('uploads/'.$sambutan->foto) }}" width="100">
                                    </div>
                                    <div class="form-group">
