...
<head>
    ...
    <title>Tambah Data Sejarah Sekolah</title>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data Sejarah Sekolah</h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row">
                                    <a href="{{route('sejarah.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i> Kembali </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form method="post" action="{{ route('sejarah.store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="squareText">Sejarah Sekolah</label>
