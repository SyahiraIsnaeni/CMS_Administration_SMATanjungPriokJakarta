...
<head>
    ...
    <title>Edit Data Sejarah Sekolah</title>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data Sambutan Kepala Sekolah</h3>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-head-row">
                            <a href="{{route('sejarah.index')}}" class="btn btn-warning btn-sm ml-auto"> <i class="bi bi-arrow-left-circle"></i></i> Kembali </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <form method="post" action="{{ route('sejarah.update', $sejarah->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="squareText">Edit Data Sejarah Sekolah</label>
                                        <textarea name="sejarah" id="sejarah" class="form-control" style="height: 300px">
                                            {{$sejarah->sejarah}}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
