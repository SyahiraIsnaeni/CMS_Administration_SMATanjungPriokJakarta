...
<head>
    ...
    <title>Data Struktur Organisasi Sekolah</title>
...
<div id="app">
    @include('back.administrasi.sidebar.struktural')
    <div id="main">
        <header class="mb-3">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Data Struktur Organisasi Sekolah</h3>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="card-header">
                                        <div class="card-head-row" style="margin-left: -20px">
                                            <a href="{{route('struktural.create')}}" class="btn btn-info btn=sm ml-auto"> <i class="bi bi-plus-circle" style="margin-right: 4px"></i>Tambah Data</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="table table-bordered mb-3" id="table1">
                                                        ...
                                                        @forelse ($struktural as $row)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <br>
                                                                    <form action="{{route('struktural.destroy', $row->id)}}" method="post"
                                                                          class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
