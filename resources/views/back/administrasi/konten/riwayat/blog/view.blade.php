...
<div id="app">
    @include('back.administrasi.sidebar.riwayat-blog')
    <div id="main">
        <header class="mb-3">
                                                        ...
                                                        @forelse ($blog as $row)
                                                            @if ($row->delete == 'Y')
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{route('riwayat-blog.edit', $row->id) }}"
                                                                           class="btn btn-warning btn-sm" style="">Restore</a>

                                                                        <form action="{{route('riwayat-blog.destroy', $row->id)}}" method="post"
                                                                              class="d-inline">
                                                                            @csrf
                                                                            @method('DELETE')
