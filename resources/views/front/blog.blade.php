...
<head>
    ...
    <title>SMA Tanjung Priok Jakarta | Blog Sekolah</title>
    <!-- add icon link -->
...
<div class="container">
    ...
    <div class="content">
        ...
        <p class="penulis" style="margin-top: -15px">{{$blog->created_at->format('d M Y')}} | {{$blog->kategori_blog->nama_kategori}}</p>
                        ...
                        <div class="foto card">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-outline-secondary">
                                    <a class="text-black" href="{{route('detail-blog', $row->slug)}}" style="text-decoration: none;">
                                        Selengkapnya
                                    </a>
                                </button>
                            </div>
